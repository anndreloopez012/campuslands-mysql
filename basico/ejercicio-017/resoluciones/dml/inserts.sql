...
-- Carga de Productos (Uso de ENUM, DECIMAL y BOOLEAN)
...
-- Carga de Clientes (Uso de DATE 'YYYY-MM-DD')
...
-- Carga de Ventas (Uso de DATETIME 'YYYY-MM-DD HH:MM:SS')
...
(5, 4, 3, 255.00, '2026-08-12 11:20:00'),
(6, 1, 1, 195.00, '2026-08-15 09:10:00');