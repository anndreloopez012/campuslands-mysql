...
('Carlos Mendoza', 'Madrid'),
('Laura Gomez', 'Barcelona'),
('Miguel Torres', 'Valencia'),
('Ana Ruiz', 'Sevilla'),
('David Lopez', 'Bilbao'),
('Sofia Perez', 'Malaga');

INSERT INTO sales (customer_id, car_id, sale_date, total) VALUES
(1, 1, '2026-01-15', 3200000.00),
(2, 3, '2026-02-10', 650000.00),
(3, 2, '2026-03-08', 3500000.00),
(4, 4, '2026-04-20', 620000.00),
(5, 5, '2026-05-12', 2200000.00),
(6, 6, '2026-06-18', 1800000.00);