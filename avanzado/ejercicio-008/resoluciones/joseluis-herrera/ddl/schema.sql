...
-- Asignando permisos
GRANT SELECT, INSERT, UPDATE ON db_futbol_sala_3fn.jugadores TO 'rol_entrenador';
GRANT SELECT ON db_futbol_sala_3fn.equipos_sala TO 'rol_entrenador';

-- Creamos al usuario
CREATE USER 'entrenador_equipo'@'localhost' IDENTIFIED BY 'PasswordEntrenador2026*';
-- Asignamos el rol correspondiente
GRANT 'rol_entrenador' TO 'entrenador_equipo'@'localhost';
SET DEFAULT ROLE 'rol_entrenador' FOR 'entrenador_equipo'@'localhost';
