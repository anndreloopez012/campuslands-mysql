...
Una academia tecnica esta construyendo un modulo de datos inspirado en carreras urbanas. El objetivo es guardar informacion ordenada, consultar indicadores utiles y dejar scripts SQL faciles de revisar por otro desarrollador.
...
## Objetivo
Practicar UNIQUE en MySQL creando una solucion que pueda ejecutarse desde cero y que demuestre analisis, orden y criterio tecnico.
...
```text
intermedio/ejercicio-010/resoluciones/juan-perez/
├── README.md
├── ddl/schema.sql
├── dml/inserts.sql
└── dql/consultas.sql
